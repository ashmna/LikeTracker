        ...
        <td width="" valign="top" style="height:100%;width:75%;">
            <div class="right_block">
                ...
                <div class="line_block">
                    ...
                    <center>
                        <div class="button_1"><a href="http://snebes.ru/add_tasks.php?t=1">Накрутить <b>"Мне
                                    нравится"</b></a></div>
                    </center>
                    <center>
                        <div class="button_1"><a href="http://snebes.ru/add_tasks.php?t=2">Накрутить <b>"Сообщество"</b></a>
                        </div>
                    </center>
                    <center>
                        <div class="button_1"><a href="http://snebes.ru/add_tasks.php?t=3">Накрутить <b>"Друзей"</b></a>
                        </div>
                    </center>
                    <center>
                        <div class="button_1"><a href="http://snebes.ru/add_tasks.php?t=4">Накрутить <b>"Рассказать
                                    друзьям"</b></a></div>
                    </center>
                    <center>
                        <div class="button_1"><a href="http://snebes.ru/add_tasks.php?t=5">Накрутить <b>"Опрос"</b></a>
                        </div>
                    </center>
                    <center>
                        <div class="button_1"><a href="http://snebes.ru/add_tasks.php?t=6">Накрутить <b>"Комментарии"</b></a>
                        </div>
                    </center>
                </div>
            </div>
